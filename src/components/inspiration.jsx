      ...
      <div className="inspiration">
        <div id="inspiration">
          <div className="absolute">
            ...
            <p className="absolute-text">My name is Bradley, I am a shamanic practitioner of the indigenous traditions of Peru.</p>
            <p className="absolute-text padding-bottom-40px">I have certified training with master shamans in a range of healing methods and am offering energy healing sessions by donation to support you at this time.</p>
