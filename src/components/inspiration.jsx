      ...
      <div className="inspiration">
        <div id="inspiration">
          <div className="absolute">
            ...
            <p className="absolute-text">My name is Bradley, I am an authentic lineage holder & practitioner of the Inca <a className="insp-anchor" target="_blank" href="https://en.wikipedia.org/wiki/Q%27ero">(Q'ero)</a> shamanic traditions of Peru.</p>
            <p className="absolute-text padding-bottom-40px">I have certified training with master shamans in a range of healing methods and offer distance energy healing sessions by donation for your healing, transformation, and self-empowerment.</p>
