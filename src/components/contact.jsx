      ...
      <div className="contact">
        ...
        <div className="content-background-colour">
          <div className="contact padding-top-40px padding-bottom-80px">
            ...
            <p><a href="public/resources/bradley-reeder-cv-ux.PDF" download onClick={ga(‘send’, ‘event’, ‘PDF’, ‘Download’, ‘CV – PDF Download’);}><i className="fa fa-download" aria-hidden="true"></i>Download CV</a></p>
